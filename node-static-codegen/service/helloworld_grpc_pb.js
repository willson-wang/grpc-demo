...
function serialize_helloworld_TimeReply(arg) {
  if (!(arg instanceof helloworld_pb.TimeReply)) {
    throw new Error('Expected argument of type helloworld.TimeReply');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_helloworld_TimeReply(buffer_arg) {
  return helloworld_pb.TimeReply.deserializeBinary(new Uint8Array(buffer_arg));
}
...
sayHello: {
  ...
  getTime: {
    path: '/helloworld.Greeter/GetTime',
    requestStream: false,
    responseStream: false,
    requestType: helloworld_pb.HelloRequest,
    responseType: helloworld_pb.TimeReply,
    requestSerialize: serialize_helloworld_HelloRequest,
    requestDeserialize: deserialize_helloworld_HelloRequest,
    responseSerialize: serialize_helloworld_TimeReply,
    responseDeserialize: deserialize_helloworld_TimeReply,
  },
};
